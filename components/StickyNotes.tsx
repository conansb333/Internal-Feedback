    ...
    <div className="p-8 h-full overflow-y-auto bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-200">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-4">
        <div className="flex items-center gap-4">
           ...
           <div>
              ...
              <p className="text-slate-500 dark:text-slate-400 mt-1">Drag to reorder. Customize colors and size.</p>
           </div>
        </div>
      ...
      {isLoading ? (
          ...
          <div className="text-center py-20 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl">
              ...
              <button onClick={addNote} className="mt-2 text-indigo-600 dark:text-indigo-400 font-bold hover:underline">Create your first note</button>
          </div>
      ) : (
